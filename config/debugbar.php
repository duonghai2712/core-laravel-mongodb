...
return [
     ...
     */
      ...
      'enabled' => (@$_COOKIE[config('app.debug_key')]==config('app.debug_sec') || @$_GET[config('app.debug_key')]==config('app.debug_sec')),
